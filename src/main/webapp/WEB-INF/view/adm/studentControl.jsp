...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function flistDtlCodResult(data, currentPage) {
        ...
        // 페이지 네비게이션 생성
	    var lec_nm = $("#tmpGrpCodNm").val(); // 현재 페이지에서 가져온 lec_nm 값
	    var paginationHtml = getPaginationHtml(currentPage, totalCntComnDtlCod, pageSizeComnDtlCod, pageBlockSizeComnDtlCod, 'fListComnDtlCod', [lec_nm]);
